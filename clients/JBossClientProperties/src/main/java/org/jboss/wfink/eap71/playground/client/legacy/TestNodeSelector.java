 ...
 */
public class TestNodeSelector implements DeploymentNodeSelector, ClusterNodeSelector {
  private static final Logger log = Logger.getLogger(TestNodeSelector.class);
